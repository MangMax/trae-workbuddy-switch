...
export function screenshotDemoResponse(command: string, args?: Record<string, unknown>): unknown {
  ...
  switch (command) {
    ...
    case "check_update": return { ok: true, current: "2026.9.16", latest: "2026.9.17", latestTag: "v2026.9.17", hasUpdate: true, releaseName: "更新提示演示", releaseUrl: "https://github.com/MangMax/trae-workbuddy-switch/releases/tag/v2026.9.17" };

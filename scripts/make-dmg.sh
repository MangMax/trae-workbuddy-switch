...
#   arch: aarch64 | x64
#   .app 路径默认 target/release/bundle/macos/BuddySwitch.app
...
V=$1
ARCH=$2
APP=${3:-target/release/bundle/macos/BuddySwitch.app}
...
OUT="BuddySwitch_${V}_${ARCH}.dmg"
TMP_DIR=$(mktemp -d "${TMPDIR:-/tmp}/BuddySwitch-dmg.XXXXXX")
TMP_OUT="$TMP_DIR/$OUT"
